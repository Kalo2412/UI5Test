...
import { DestinationsAndCertificatesOnAccountLevelApi } from '../generated/SAP_CP_Neo_Connectivity_Destination';
...
export default class Main extends BaseController {
	async onInit(): Promise<void> {
		...
		const responseData = await DestinationsAndCertificatesOnAccountLevelApi.getOauthSpacesConnectivityByAccount(account).execute({ destinationName: 'myDestinationName' });
